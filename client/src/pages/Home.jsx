  ...
  return (
    <main className="min-h-screen w-full m-0 bg-[#76816A] font-['Inter']">
      ...
      <section className="w-full min-w-[314px] max-w-[850px] mx-auto px-8 sm:px-4 md:px-14 lg:px-20 mb-36 text-[#F5F5F5]">
        <h1 className="font-bold mt-10 mb-8 sm:my-6 md:my-10 text-4xl">EL REFUGIO</h1>
        ...
        <ul className="list-inside list-disc mb-10 sm:mb8">
          <li className="pb-6 sm:pb-4">Rescatamos a perros y gatos en situación de vulnerabilidad</li>
          <li className="pb-6 sm:pb-4">Proporcionamos atención veterinaria completa</li>
        ...
        <i className="font-serif text-[#31442C] block mb-10 sm:mb-4">En Rescue Factoría, no solo salvamos vidas, creamos familias.</i>
      </section>
